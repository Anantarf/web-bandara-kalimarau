<x-layouts.public>
    <div class="py-20 bg-gray-50 min-h-[70vh] flex items-center">
        <div class="container mx-auto px-4 text-center max-w-2xl"
            ...
            <p class="text-lg text-text-muted mb-8">Maaf, halaman yang Anda cari mungkin telah dihapus, namanya diubah, atau tidak tersedia untuk saat ini.</p>

            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('home') }}" class="bg-navy hover:bg-navy-dark text-white font-semibold py-3 px-6 rounded-md transition-colors inline-flex items-center justify-center">
