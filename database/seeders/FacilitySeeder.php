...
class FacilitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $facilities = [
            ...
            ['category' => 'Aksesibilitas', 'name' => 'Pegangan Rambat', 'image' => 'facilities/jalur-landai.jpg', 'details' => ['Fasilitas pegangan rambat (handrail) untuk menunjang keamanan dan kenyamanan mobilitas di area terminal.', 'Membantu keseimbangan serta keselamatan bagi lansia, difabel, dan penumpang prioritas yang membutuhkan.']],
